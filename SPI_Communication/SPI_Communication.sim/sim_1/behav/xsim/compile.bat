...
REM
REM Generated by Vivado on Sat May 16 19:56:37 +0700 2026
...
echo "xvlog --incr --relax -prj spi_communication_tb_vlog.prj"
call xvlog  --incr --relax -prj spi_communication_tb_vlog.prj -log xvlog.log
